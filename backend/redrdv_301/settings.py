"""
Django settings for redrdv_301 project.
...
WSGI_APPLICATION = 'redrdv_301.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "redrdv_301 API",
    "DESCRIPTION": "API documentation for redrdv_301 App",
    "VERSION": "v1",
}
